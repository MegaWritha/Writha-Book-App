...
export default function CreateResearch() {
  ...
  const resWordCount = resManualContent.trim()
    ? resManualContent.trim().split(/\s+/).length
    : 0;
  ...
  const handleSubmitResearch = async (status: "draft" | "pending") => {
    ...
    try {
      ...
      Alert.alert(
        ...
        status === "pending"
          ? "Your research has been submitted for admin review. You'll be notified when approved."
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          {resMethod === "MANUAL" && (
            <>
              <SectionLabel label="RESEARCH BODY (NO LIMIT)" icon="create-outline" />
              <TextInput
                style={styles.bodyInput}
                placeholder={"Write your full research here...\n\nMin 300 characters required for submission. No word limit."}
                placeholderTextColor={THEME.textMuted}
                multiline
          ...
          {resMethod === "PDF" && (
            <>
              ...
              {resPdfUrl ? (
                ...
                <TouchableOpacity style={styles.pdfDropzone} onPress={pickPdf} disabled={uploading}>
                  {uploading ? (
                    ...
                    <>
                      ...
                      <Text style={styles.pdfDropzoneSub}>Maximum file size: 20MB · No page limit</Text>
                    </>
                  )}
                </TouchableOpacity>
              )}
          ...
          <View style={styles.reviewInfoBox}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.reviewInfoTxt}>
                Research submissions are reviewed before going live. This usually takes 24–48 hours.
...
const styles = StyleSheet.create({
  ...
  typeBadge: {
    ...
    backgroundColor: THEME.purpleLight, paddingHorizontal: 14,
    paddingVertical: 8, borderRadius: 12,
  },
  typeBadgeTxt: { color: "#000", fontWeight: "900", fontSize: 12, letterSpacing: 1 },
  draftHeaderBtn: {
    borderWidth: 1, borderColor: THEME.purpleLight, paddingHorizontal: 14,
  ...
  methodCard: {
    flex: 1, backgroundColor: THEME.ui, borderRadius: 16, padding: 14,
    alignItems: "center", gap: 6, borderWidth: 1, borderColor: THEME.ui2,
  },
  ...
  coverPicker: {
    ...
    borderWidth: 1.5, borderColor: THEME.ui2, borderStyle: "dashed",
  },
  coverEmpty: {
    height: 140, backgroundColor: THEME.ui,
  ...
  titleInput: {
    backgroundColor: THEME.ui, color: THEME.text, borderRadius: 14,
    padding: 16, fontSize: 16, fontWeight: "700",
    borderWidth: 1, borderColor: THEME.ui2,
  },
  abstractInput: {
    backgroundColor: THEME.ui, color: THEME.text, borderRadius: 14,
    padding: 16, fontSize: 14, minHeight: 120, textAlignVertical: "top",
    lineHeight: 22, borderWidth: 1, borderColor: THEME.ui2,
  },
  fieldInput: {
    backgroundColor: THEME.ui, color: THEME.text, borderRadius: 14,
    padding: 16, fontSize: 14, borderWidth: 1, borderColor: THEME.ui2,
  },
  ...
  tagInput: {
    ...
    paddingHorizontal: 14, paddingVertical: 10, color: THEME.text,
    borderWidth: 1, borderColor: THEME.ui2, fontSize: 14,
  },
  tagAddBtn: {
  ...
  tagPill: {
    ...
    backgroundColor: THEME.accentDim, paddingHorizontal: 10, paddingVertical: 5,
    borderRadius: 10, borderWidth: 1, borderColor: THEME.accent + "40",
  },
  tagPillTxt: { color: THEME.accent, fontSize: 12, fontWeight: "700" },
  bodyInput: {
    backgroundColor: THEME.ui, color: THEME.text, borderRadius: 14,
    padding: 16, minHeight: 350, fontSize: 15, lineHeight: 24,
    textAlignVertical: "top", borderWidth: 1, borderColor: THEME.ui2,
  },
  scriptBox: { backgroundColor: THEME.bg, borderRadius: 14, borderWidth: 1, borderColor: THEME.ui2 },
  scriptInput: {
    color: THEME.text, padding: 16, minHeight: 300,
    fontSize: 14, lineHeight: 22,
    fontFamily: Platform.OS === "ios" ? "Courier New" : "monospace",
    textAlignVertical: "top",
  },
  wordCountBar: {
    flexDirection: "row", backgroundColor: THEME.ui, borderRadius: 14,
    padding: 14, marginTop: 12, borderWidth: 1, borderColor: THEME.ui2,
  },
  ...
  pdfDropzone: {
    height: 160, backgroundColor: THEME.ui, borderRadius: 16,
    borderWidth: 2, borderColor: THEME.ui2, borderStyle: "dashed",
  ...
  pdfUploaded: {
    ...
    borderWidth: 1, borderColor: THEME.green + "50",
  },
  pdfUploadedIcon: {
    width: 48, height: 48, borderRadius: 12,
    backgroundColor: THEME.red + "20", justifyContent: "center", alignItems: "center",
  },
  pdfFileName: { color: THEME.text, fontWeight: "700", fontSize: 13 },
  pdfFileSize: { color: THEME.green, fontSize: 11, marginTop: 3 },
  priceInputWrap: {
    flexDirection: "row", alignItems: "center", backgroundColor: THEME.ui,
    borderRadius: 14, padding: 16, borderWidth: 1, borderColor: THEME.ui2,
  ...
  reviewInfoBox: {
    flexDirection: "row", gap: 12, backgroundColor: THEME.accentDim,
    borderRadius: 16, padding: 16, marginTop: 20,
    borderWidth: 1, borderColor: THEME.accent + "30", alignItems: "flex-start",
  },
