...
import {
  ...
  Switch, Alert, StatusBar, ActivityIndicator
} from "react-native";
...
export default function SettingsScreen() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      title: "DANGER ZONE",
      items: [
        { icon: "log-out-outline", label: "Log Out", type: "danger", onPress: handleLogout },
        { icon: "trash-outline", label: "Delete Account", type: "danger", onPress: handleDeleteAccount },
      ],
    },
  ];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.profilePreview}>
        ...
        <View>
          ...
          <Text style={styles.profileUsername}>@{profile?.username || "thinker"}</Text>
        </View>
      </View>
                ...
                >
                  <View style={styles.rowLeft}>
                    <View style={[styles.iconWrap, item.type === "danger" && styles.iconDanger]}>
                      <Ionicons name={item.icon as any} size={18} color={item.type === "danger" ? "#FF4444" : "#FFD700"} />
                    </View>
                    <Text style={[styles.rowLabel, item.type === "danger" && styles.dangerLabel]}>
                      {item.label}
                    </Text>
                  </View>
                  {item.type === "toggle" && (
...
const styles = StyleSheet.create({
  ...
  iconDanger: { backgroundColor: "#2D0A0A" },
